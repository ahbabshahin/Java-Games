...
public class Sports extends JFrame implements ActionListener {
    ...
    String[] questions = {"When did National Sports Council has been formed?",
            "When did Bangladesh get the World Olympic's membership?",
            "Who was the fastest women of Bangladesh in 2018?",
            "Who was the first National Football League champion?",
            "Who was the first captain of National Football team?",
            "Which Saf game champion was Bangladesh Football team?",
            "Which was the former name of Bangladesh Cricket Board?",
            "Who was the first chairman of Bangladesh Cricket Board?",
            "Bangladesh Cricket team played his first One day match against.....",
            "Bangladesh gained his One day status in....."};

    String[][] option = {{"1973", "1972", "1974", "1975"},
            {"16 February 1980", "2 September 1976", "10 January 1972", "15 February 1980"},
            {"Sherin Akther", "Sherin Sharmeen", "Solma Akther", "Mahfuja Sarwar Fortune"},
            {"Muktijuddah Shangshod", "Sheikh Rasel", "Dhaka Abahoni", "Dhaka Mohamedan"},
            {"Gazi Salauddin", "Jakaria Pintu", "Jahed Khan", "MD.K Malik"},
            {"1st", "10th", "4th", "8th"},
            {"Bangladesh Cricket Federation", "Bangladesh Cricket Board", "Bangladesh Cricket Control Board", "Bangladesh Cricket Council"},
            {"Ali Amjad Khan", "Nazmul Hasan Papon", "MD.Yousuf Ali", "MD. Jafrullah"},
            {"Pakistan", "India", "New Zealand", "Scotland"},
            {"2000", "1995", "1999", "1997"}};

    char[] answers = {'B', 'D', 'A', 'C', 'B', 'D', 'C', 'C', 'A', 'D'};
