...
public class SocialMedia extends JFrame implements ActionListener {

    String[] questions = {"What is meant by micro-blogging?",
            "What is the name of Facebook's analytic package?",
            "Social networks are organized primarily around....",
            "Which of the following is owned by Microsoft?",
            "When did Facebook extend reactions to the comments section?",
            "When was Instagram released to the Android platform?",
            "Who of the following is not a co-creator of Twitter?",
            "When was verified account system for public figures introduced on Instagram?",
    ...
    String[][] option = {{"Blogs which are posted by companies, not individuals", "Blogs with limited individual posts, limited by character count typically", "Blogging from mobile devices", "All of the above"},
            {"Princeps", "Viewership", "Discover", "Insights"},
            {"brands", "people", "discussions", "interests"},
            {"LinkedIn", "Twitter", "Youtube", "Instagram"},
            {"July, 2016", "February, 2016", "August, 2017", "May, 2017"},
            {"October, 2010", "April, 2012", "December, 2011", "May, 2011"},
            {"Jack Dorsey", "Evan Williams", "Mike Krieger", "Noah Glassns"},
            {"2014", "2011", "2015", "2018"},
            {"Wiki", "Online forum", "Usenet", "Social network"},
            {"MySpace", "Twitter", "Facebook", "Weibo"}
    };

    char[] answers = {'B', 'D', 'B', 'A', 'D', 'B', 'C', 'C', 'A', 'C'};
