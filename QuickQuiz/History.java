...
public class History extends JFrame implements ActionListener {
    ...
    String[] questions = {"Where was the Capital of Sena?",
            "When was the rule of Muslim Established in Bengal?",
            "Who was the last Hindu King of Bengal?",
            "Who introduced Koulinyo Tradition in Bengal?",
            "Who was Deb Paul?",
            "Who was the Last King of Paul Dynasty?",
            "When was Gupta Empire established in Bengal?",
            "Where was the Ancient Capital of Gupta's?",
            "Who was described as the Napoleon of India?",
            "Who was the Greatest Sultan of Bengal?"};

    String[][] option = {{"Bongo", "Patliputra", "Nobo Dip", "Mahasthan Gar"},
            {"In the time of Laksman Sen", "In the time of Bijay Sen", "In the time of Tang Sen", "In the time of Gopal sen"},
            {"Hemanta Sen", "Ballal Sen", "Bijay Sen", "Laksman Sen"},
            {"Sree Chaitanya Deb", "Ballal Sen", "Ram Paul", "Bijay Sen"},
            {"The Son of Dharam Paul", "The Son of Ballal Sen", "The Son of Ram Paul", "The Son of Bijay Sen"},
            {"Nandi Paul", "Gopal", "Dharam Paul", "Ram Paul"},
            {"711 B.C", "570 A.C", "320 A.C", "320 B.C"},
            {"Patliputra", "Bongo", "Nobo Dip", "Mahasthan Gar"},
            {"Chandra Gupta", "Samudra Gupta", "Jalal Uddin Mohammed Akbar", "Alauddin Khilji"},
            {"Alauddin Husen Shah", "Musa Khan", "Fakruddin mubarak Shah", "Shamsuddin Feruz Shah"}};

    char[] answers = {'C', 'A', 'D', 'B', 'A', 'D', 'C', 'A', 'B', 'D'};
